...
<div class="bg-white p-6 rounded-lg shadow max-w-2xl mx-auto">
    <h1 class="text-2xl font-bold mb-6">Tambah Kategori Obat</h1>

    <form action="/relasional-obat" method="POST">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea name="keterangan" rows="3" 
                class="w-full px-4 py-2 border border-slate-300 rounded focus:outline-none focus:border-blue-500">{{ old('keterangan') }}</textarea>
            @error('keterangan')
            <span class="text-red-600 text-sm">{{ $message }}</span>
            @enderror
        </div>
